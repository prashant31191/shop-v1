            ...
            <ul class="navbar-nav">
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Social</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('socials.new') }}">Create New</a>
                        <a class="dropdown-item" href="{{ route('socials.list') }}">List All</a>
                    </div>
                </li>
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Platforms</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('socials.platforms.new') }}">Create New</a>
                        <a class="dropdown-item" href="{{ route('socials.platforms.list') }}">List All</a>
                    </div>
                </li>  
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Product</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('admin.products.list') }}">List All</a>
                        <a class="dropdown-item" href="{{ route('admin.import.aliexpress') }}">Import from AliExpress</a>
                    </div>
                </li> 
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Region</a>
                    <div class="dropdown-menu">
                        <a class="dropdown-item" href="{{ route('countries.list') }}">Country List</a>
                        <a class="dropdown-item" href="{{ route('regions.list') }}">Region List</a>
                        <a class="dropdown-item" href="{{ route('admin.import.regions') }}">Import</a>
                    </div>
                </li> 
                ...
                <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Subscribers</a>
                    <div class="dropdown-menu">                   
                        <a class="dropdown-item" href="{{ route('admin.subscribes') }}">List All</a>
                        <a class="dropdown-item" href="{{ route('admin.import.emails') }}">Import Random</a>
                    </div>
                </li> 
