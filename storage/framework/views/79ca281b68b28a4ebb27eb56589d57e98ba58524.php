        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">Social Accounts</a>
            <div class="dropdown-menu">
              <a class="dropdown-item" href="/shop-v1/public/socials/new">NEW</a>
              <a class="dropdown-item" href="/shop-v1/public/socials/list">LIST</a>
            </div>
        </li>
...
</html><?php /**PATH D:\SERVER\shop-v1\resources\views/public/layout.blade.php ENDPATH**/ ?>