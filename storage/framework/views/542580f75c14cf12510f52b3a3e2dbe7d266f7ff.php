    ...
    -->
      ...
      <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            <li>
                <a href="<?php echo e(route('admin.products.list')); ?>">
            ...
            <li>
                <a href="<?php echo e(route('admin.subscribes')); ?>">
                <i class="fas fa-at"></i>
                <p>Subscribers</p>
                </a>
            </li>
            ...
            <li>
                <a href="<?php echo e(route('countries.list')); ?>">
            ...
            <li>
                <a href="<?php echo e(route('regions.list')); ?>">
                <i class="fas fa-globe"></i>
                <p>Regions</p>
                </a>
            </li>  
            ...
            <li>
                <a href="<?php echo e(route('socials.list')); ?>">
            ...
            <li>
                <a href="<?php echo e(route('socials.platforms.list')); ?>">
        ...
        <ul class="nav">
          ...
          <li>
              <a href="<?php echo e(route('backup_all')); ?>">
          ...
          <li>
            <a href="<?php echo e(route('backup_db')); ?>">
          ...
          <li>
            <a href="<?php echo e(route('backup_files')); ?>">
...
<?php /**PATH D:\SERVER\shop-v1\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>